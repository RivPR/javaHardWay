...
public class ShapeArea {
  public static void main( String[] args ){
    ...
    System.out.println(" (c) 2016 LTJtHW Sample output, Inc.");
    ...
    do {
      ...
      if (choice == 1 ) {
        ...
        System.out.println("The area if " + computeSquareArea(side) );
      }
      else if ( choice != 5 ) {
  ...
  public static int computeRectangleArea( int lenght, int width ) {
    return ( lenght * width);
  }
